...
public class WorkRulesTests
{
    ...
    {
        var d1 = new DatedWorkSummary(new DateOnly(2026, 2, 1), WorkRules.ComputeDay(540, 540 + 60, 0)); // +55
        var d2 = new DatedWorkSummary(new DateOnly(2026, 2, 2), WorkRules.ComputeDay(540, 540 - 60, 0)); // -55 uses bank
        var d3 = new DatedWorkSummary(new DateOnly(2026, 2, 3), WorkRules.ComputeDay(540, 540 - 60, 0)); // -55 deficit
